...
<body class="font-Ubuntu text-white">
    ...
    <div class="flex h-full w-full bg-TEMP1-o-fill">
        <br>
        <br>
        <br>
        <br>
        <div class="m-3 flex flex-col w-full bg-TEMP1-i-fill p-4 gap-3 overflow-y-scroll rounded-xl mt-20">
            ...
            <div class="flex flex-col w-full gap-5 mt-3">
                <div class="relative h-[0.06rem] w-full bg-gray-300 mt-2">
                    <p class="absolute text-white opacity-100 -top-3 left-5 bg-TEMP1-i-fill px-3">
                        General Information
                    </p>
                </div>
